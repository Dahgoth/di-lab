        ...
        headers: [
          {
            ...
            value: [
              ...
              "base-uri 'self'",
              "form-action 'self'",
              "frame-ancestors 'self' https://*.kiloapps.io https://*.vercel.app https://vercel.app https://*.builder.kiloapps.io https://kiloapps.io https://builder.kiloapps.io *", // Allow self and preview services
            ].join("; "),
          },
          {
